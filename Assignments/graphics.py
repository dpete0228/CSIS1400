...
class Image(GraphicsObject):
    ...
    def setPixelRed(self, x, y, new_color):
        ...
        if type(old_color) is list:
            if new_color > 255:
                print("A red component color greater than 255 was detected")
    ...
    def setPixelGreen(self, x, y, new_color):
        ...
        if type(old_color) is list:
            if new_color > 255:
                print("A green component color greater than 255 was detected")
    ...
    def setPixelBlue(self, x, y, new_color):
        ...
        if type(old_color) is list:
            if new_color > 255:
                print("A blue component color greater than 255 was detected")
